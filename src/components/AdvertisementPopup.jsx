...
const AdvertisementPopup = () => {
    ...
    const isClosed = localStorage.getItem("advertisementPopup")
...
<dialog ref={advertisementRef} className='half-black-backdrop sm:h-[80vh] sm:w-[80vw] lg:w-[40vw] p-0 bg-transparent'>
    <div className='flex flex-col items-center p-0 bg-transparent'>
        <div className='relative'>
            <Image src={"/1.png"} alt='discount' width={400} height={500} className='w-full sm:h-[600px] h-[500px]' />
