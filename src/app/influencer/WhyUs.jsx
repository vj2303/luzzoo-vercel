...
const WhyUs = () => {
    ...
    return (
        <div className='flex flex-col gap-[15px] mx-[15px] my-[30px]  max-w-[1200px] mx-auto'>
            <h2 className='text-[20px] font-semibold'>Become a part of the campaign</h2>
            <p className='text-[#7E7E7E] text-[14px] font-[400px] leading-[21px]'>Join our exclusive community tailored just for you. We&apos;re all about empowering your creativity and providing a platform for your unique voice to shine. Get ready to network, grow your influence, and be part of a community that celebrates your individuality while elevating your beauty & wellness.</p>
